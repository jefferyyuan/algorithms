 ...
 * Uses arrays of bytes to group bits by 8 together. Uses bit manipulation
 * operations for fast access to individual bits. Once created, the bit array
 * can't be extended (shorten or prolonged).
 * 
 * @author dpavlis
...
public class BitArray
{
     ...
     * 
     * @param size
     *            how many bits should the array keep
     */
    ...
    /**
     * Formats BitArray into String where set bits are displayed as 1 and reset
     * as 0
     * 
    ...
    /*
     * public static void main(String args[]){ BitArray array=new BitArray(16);
     * array.set(8); array.set(0); array.set(10); array.set(7);
     * System.out.println(array.get(1)); System.out.println(array.get(0));
     * System.out.println(array.get(8)); System.out.println(array.get(9));
     * System.out.println(array.get(10)); System.out.println(array);
     * array.reset(10); array.set(1); array.reset(7);
     * System.out.println(array.get(10)); System.out.println(array); }
     */
}
/*
