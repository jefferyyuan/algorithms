package org.codeexample.algorithms.collected.porterstemmer;
...
/************************************
 * Class: paicedemo * * Purpose: Stemming Algorithm *
 ************************************/
public class PaiceDemo
{
    ...
    /************************************
     * Method: paicedemo * (constructor) * * Purpose: init *
     ************************************/
    public PaiceDemo(String rules, String pre)
    {
            ...
            String stemRules, boolean def)
    {
        ...
        try
        {
            ...
            catch (Exception e)
            {
                ...
                {
                    System.out.println("File Error Using " + stemRules
                            + " Using default 'stemrules' file instead");
    ...
    private String stripPrefixes(
            String str)
    {
        String[] prefixes = { "kilo", "micro", "milli", "intra", "ultra", "mega", "nano", "pico",
                "pseudo" };
    ...
    /************************************************************
     * Method: fileOption * Returns: void * Recives: String inputFile,
     * outputFile * Purpose: Output stemming results to a file *
     ************************************************************/
    ...
    /************************************************************
     * Method: wordsOption * Returns: void * Recives: String words * Purpose:
     * Output stemming results to the screen *
     ************************************************************/
    private void wordsOption(
            String words)
    {
    ...
    public String stripAffixes(
            String str)
    {
        str = Clean(str.toLowerCase()); // change all letters in the input to
                                        // lowercase
