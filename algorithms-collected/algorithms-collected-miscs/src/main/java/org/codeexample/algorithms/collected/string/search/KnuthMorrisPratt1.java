...
public class KnuthMorrisPratt1 {
	/** Failure array **/
	private int[] failure;

	/** Constructor **/
	public KnuthMorrisPratt1(String text, String pat) {
	...
	public static void main(String[] args) throws IOException {
		String text = "abxababaa";
		String pattern = "abcdabd";// "ababaa";
		...
		KnuthMorrisPratt1 kmp = new KnuthMorrisPratt1(text, pattern);
	}
}