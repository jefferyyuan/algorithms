...
/**
 * Source: http://homepage.cs.uiowa.edu/~hzhang/c231/codes/
 * 
 */
public class Maxflow
{
    ...
    private void inputCapacity() throws IOException
    {
        BufferedReader br = new BufferedReader(
                new FileReader(
                        "C:\\Jeffrey\\my-projects\\github\\algorithms\\algorithms-collected\\algorithms-collected-miscs\\src\\main\\java\\org\\codeexample\\algorithms\\collected\\graph\\maxflow\\edgeCapacity.txt"));
     ...
     * 
     * The first line specifies n and m, the number of vertices and the number
     * of edges. The source is assumed to be 0 and the sink is assumed to be
     * n-1.
     * 
     * The rest lines specify the m edges, one per line, by three numbers: start
     * vertex, end vertex, and its capacity.
     */
