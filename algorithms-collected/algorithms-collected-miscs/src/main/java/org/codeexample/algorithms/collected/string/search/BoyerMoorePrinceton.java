...
public class BoyerMoorePrinceton {
	...
	public BoyerMoorePrinceton(String pat) {
		this.R = 256;
		this.pat = pat;
	...
	public BoyerMoorePrinceton(char[] pattern, int R) {
		this.R = R;
	...
	public static void main(String[] args) {
		...
		BoyerMoorePrinceton boyermoore1 = new BoyerMoorePrinceton(pat);
		BoyerMoorePrinceton boyermoore2 = new BoyerMoorePrinceton(pattern, 256);
