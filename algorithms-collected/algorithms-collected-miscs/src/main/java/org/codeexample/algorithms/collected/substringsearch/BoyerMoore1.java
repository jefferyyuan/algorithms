 ...
 * 
 * Source: http://algs4.cs.princeton.edu/53substring/BoyerMoore.java.html
 * <p>
...
public class BoyerMoore1
{
    ...
    public BoyerMoore1(char[] pattern, int R)
    {
        this.R = R;
    ...
    public static void main(
            String[] args)
    {
        String pat = "NNAAMAN"; // args[0];
        String txt = "ANPANMANAM"; // args[1];
        char[] pattern = pat.toCharArray();
        char[] text = txt.toCharArray();

        BoyerMoore1 boyermoore1 = new BoyerMoore1(pat);
        BoyerMoore1 boyermoore2 = new BoyerMoore1(pattern, 256);
