...
public class Trie
{
    ...
    public int[] amountList = new int[26]; // keep track of the amount of each
                                           // letter
    ...
    /*
     * receives: a String str returns: a new string able to be stored in the
     * tree gets rid of all spaces, punctuation, and numbers in str, converts it
     * to lower case, and stores only words longer than three
     */
    ...
    /*
     * receives: a String str returns: nothing - inserts insert the String str
     * into the tree starting at the end of the word. each letter is inserted,
     * and based on the other elements in the list a new child is added to the
     * list, or an existing child is used.
     */
    public void insert(
            String str)
    {
    ...
    /*
     * receives: a String str returns: true if str is found, otherwise false
     * follows the tree until the start until the prefix is found. it doesn't
     * matter if str is a full word or not.
     */
    public boolean stringInTrie(
            String str)
    {
    ...
    /*
     * receives: a String str returns: true if str is found, otherwise false
     * calls stringInTrie to see if the string is there, and returns true if the
     * last node in the string ends a word
     */
    public boolean wordInTrie(
            String str)
    {
        // only return true if position starts a word, otherwise it's not in the
        // dictionary
