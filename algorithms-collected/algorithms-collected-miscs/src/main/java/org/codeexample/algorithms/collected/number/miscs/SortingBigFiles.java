 ...
 * <p>
 * http://www.codeodor.com/index.cfm/2007/5/14/Re-Sorting-really-BIG-files---the
 * -Java-source-code/1208
 * <p>
 * https://github.com/codeodor/miscellany/blob/master/java_external_sort/
 * ExternalSort.java
 * <p>
 * Until finished reading the large file <br>
 * Read a large chunk of the file into memory (large enough so that you get a
 * lot of records, but small enough such that it will comfortably fit into
 * memory).<br>
 * Sort those records in memory.<br>
 * Write them to a (new) file<br>
 * Open each of the files you created above<br>
 * Read the top record from each file<br>
 * Until no record exists in any of the files (or until you have read the
 * entirety of every file)<br>
 * Write the smallest record to the sorted file<br>
 * Read the next record from the file that had the smallest record<br>
 */
public class SortingBigFiles
{
    ...
    public static void main(
            String[] args)
    {
        String relation = "C:\\Jeffrey\\my-projects\\github\\algorithms\\algorithms-collected\\algorithms-collected-miscs\\src\\main\\java\\org\\codeexample\\algorithms\\collected\\number\\miscs\\test"; // the
                                                                                                                                                                                                           // code
                                                                                                                                                                                                           // takes
                                                                                                                                                                                                           // care
                                                                                                                                                                                                           // of
    ...
    private static Integer[] getIntsFromStringArray(
            String[] row)
    {
    ...
    private static void externalSort(
    ...
    private static void mergeFiles(
            String relation, int numFiles, int compareIndex)
    {
        try
        {
    ...
    private static ArrayList<Integer[]> mergeSort(
            ArrayList<Integer[]> arr, int index)
    {
    ...
    private static ArrayList<Integer[]> merge(
            ArrayList<Integer[]> left, ArrayList<Integer[]> right, int index)
    {
    ...
    private static String[] getRow(
            String relation, int whichReader, String extension)
    {
        String line = "";
        FileReader f;
        BufferedReader b;
    ...
    public static String[] getRow(
            String relation, String extension)
    {
        return getRow(relation, 1, extension);
    }

    public static String[] getRowInDifRelation(
            String relation, String extension)
    {
    ...
    private static String[] mergeQuotedCells(
            String[] lineAsArray)
    {
    ...
    public static void putRow(
            String relation, String row)
    {
        putRow(relation, row, ".csv");
    }

    public static void putRow(
            String relation, String row, String extension)
    {
    ...
    // each element
    private static String flattenArray(
            String[] arr, String delimiter)
    {
        String result = "";
     ...
     * the index where it found it. If it doesn't find it, it returns -1.
     */
    private static int getIndexForColumn(
