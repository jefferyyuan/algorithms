package org.codeexample.algorithms.collected.hash;
...
public class SimHash1 {
	...
	public SimHash1(String tokens) throws IOException {
		this.tokens = tokens;
		this.intSimHash = this.simHash();
	}

	public SimHash1(String tokens, int hashbits) throws IOException {
		this.tokens = tokens;
	...
	public int hammingDistance(SimHash1 other) {
	...
	public List subByDistance(SimHash1 simHash, int distance) {
		// 分成几组来检查
	...
	public static void main(String[] args) throws IOException {
		...
		SimHash1 hash1 = new SimHash1(s, 64);
		...
		SimHash1 hash2 = new SimHash1(s, 64);
		...
		SimHash1 hash3 = new SimHash1(s, 64);
