package org.codeexample.algorithms.collected.substringsearch;
...
public class BoyerMoore
{
    ...
    /**
     * Computes the function <i>last</i> and stores its values in the array
    ...
    /**
     * Computes the function <i>match</i> and stores its values in the array
     ...
     * backwards version of the KMP failure function. <br>
    ...
    public static void main(
            String[] args)
    {
        String pattern = "NNAAMAN"; // args[0];
        String text = "ANPANMANAM"; // args[1];
        
        BoyerMoore boyerMoore = new BoyerMoore(pattern, text);
        boyerMoore.match();
