...
class SuffixArray2 {
	...
	private static int assignNames(int[] s, int[] s12, int[] SA12, int n0,
			int n12, int K) {
	...
	private static void merge(int[] s, int[] s12, int[] SA, int[] SA0,
			int[] SA12, int n, int n0, int n12, int t) {
		int p = 0, k = 0;
...
//		test("banana");
	 ...
	 * @param SA existing array to place the suffix array
	 * 
	 * @param LCP existing array to place the LCP information Note: Starting in
	 * Java 7, this will use quadratic space.
	 */
