...
public class Metaphone implements StringEncoder
{
    ...
    private boolean regionMatch(
            StringBuffer string, int index, String test)
    {
        boolean matches = false;
    ...
    public Object encode(
            Object pObject) throws EncoderException
    {
            ...
            String[] args)
    {
        ...
        System.out.println(metaphone.encode("SCHEDULE"));
    }
