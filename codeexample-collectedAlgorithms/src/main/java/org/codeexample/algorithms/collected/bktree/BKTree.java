...
/**
 * Source:
 * http://code.google.com/p/cool-algorithms/source/browse/src/name/nirav/
 * bktree/BKTree.java?r=4f73180a0123643d657c89a77da77ef6ee8be9fb
 * <p>
...
public class BKTree
{
    public static class BKNode
    {
        ...
        protected BKNode childAtDistance(
                int pos)
        {
        ...
        private void addChild(
                int pos, BKNode child)
        {
            children.put(pos, child);
        }

        public List<String> search(
                String node, int maxDistance)
        {
